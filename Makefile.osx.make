...
#STATIC=
#STATIC= -shared-libgcc -lstdc++-static
#STATIC= -static-libgcc -lstdc++-static
STATIC=  -static-libgcc  -static-libstdc++
#STATIC= -static-libgcc 

# Point to source-build CCP4
CCP4=/usr/local/CCP4versions/Current
#CCP4=/usr/local/CCP4versions/ccp4-6.3.0
CLIB=${CCP4}/lib
CLIBS=${CLIB}/libccp4
...
#ICLPR=-I${CLPR}
#ICLPR=-I${CLPR}/clipper/ccp4

ICLPR=-I${CCP4}/include  -I${CCP4}/../checkout/clipper/clipper/core
...
#LDLIBS=${LMIN} ${LTBX} ${LCLPR} ${LCCP4}  ${STATIC}
LDLIBS=  ${LMIN} ${LTBX} ${LCLPR} ${LCCP4}  ${STATIC}
...
SOURCE = ${EXE}.cpp \
	...
	referencelist.cpp hkl_merge.cpp \
...
lib: ${OBJ} ${COBJ}
	ar -r libaimless.a ${OBJ} ${COBJ}

## - - -
TREXE= test-reference
# might as well chuck everything in!
TROBJ= ${TREXE}.o  ${OBJ} ${COBJ} 

${TREXE}: ${TROBJ}
	${CXX} $(LFLAGS) -o ${TREXE} ${TROBJ}  ${LDLIBS}
## - - -
TTOBJ= t.o
##TTOBJ= t.o  eprob.o string_util.o range.o fileread.o Output.o jiffy.o tablegraph.o
TTEXE= t
...
## - - -
TESTOBJ= test.o string_util.o range.o fileread.o tablegraph.o file_util.o \
	scala_util.o hkl_datatypes.o rotation.o matvec_utils.o dataset.o \
	columnlabels.o hkl_unmerge.o hkl_merge.o hash.o mtz_merge_io.o \
	runthings.o hkl_symmetry.o Output.o observationflags.o crystaltype.o \
	controls.o globalcontrols_aimless.o jiffy.o probfunctions.o \
	icering.o eprob.o
...
## - - -
# testtile
TILEOBJ= testtile.o tile.o range.o string_util.o imagearray.o file_util.o \
	hkl_datatypes.o matvec_utils.o rotation.o scala_util.o \
	testrefinetile.o Output.o tie.o jiffy.o dataset.o 

TILEEXE= testtile

testtile: ${TILEOBJ}
	${CXX} $(LFLAGS) -o ${TILEEXE} ${TILEOBJ}  ${LDLIBS}

## - - -
BOBJ= simulateB.o hkl_datatypes.o  hkl_unmerge.o \
	scala_util.o Output.o matvec_utils.o jiffy.o range.o \
	hkl_symmetry.o rotation.o controls.o hash.o crystaltype.o runthings.o \
...
UOBJ= simulate.o hkl_datatypes.o  hkl_unmerge.o \
	scala_util.o Output.o matvec_utils.o jiffy.o range.o \
	hkl_symmetry.o rotation.o hash.o crystaltype.o runthings.o \
	...
	linearlsq.o spline.o mtz_merge_io.o \
...
VOBJ= simdelta.o samplegaussian.o scala_util.o \
  ...
  score_datatypes.o spacegroupreindex.o hkl_symmetry.o latsym.o crystaltype.o \
...
export:
	...
	cp ${HDR} ../Export/
	cp ${CHDR} ../Export/
	cp Makefile ../Export/Makefile.osx
...
# copy to main LMB directories
LMB: export
	cp -R ../Export/* LMBaimless
